...
var AuthController = /** @class */ (function () {
            ...
            switch (_b.label) {
                ...
                case 5:
                    if (!user.checkPassword(password)) {
                        return [2 /*return*/, res.status(400).json('Username or password are incorrect')];
                    }
    ...
    AuthController.changePassword = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var userId, _a, oldPassword, newPassword, userRepository, user, errors, e_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    userId = res.locals.jwtPayload.userId;
                    _a = req.body, oldPassword = _a.oldPassword, newPassword = _a.newPassword;
                    if (!!(oldPassword && newPassword)) return [3 /*break*/, 1];
                ...
                case 4:
                    user = _b.sent();
                    if (!!user.checkPassword(oldPassword)) return [3 /*break*/, 5];
                ...
                case 8:
                    _b.sent();
                    return [2 /*return*/, res.json({ message: 'Password changed' })];
                case 9: return [3 /*break*/, 11];
                case 10:
                    e_2 = _b.sent();
                    return [2 /*return*/, res.status(400).json({ message: 'Something woes wrong' })];
