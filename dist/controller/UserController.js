...
var UserController = /** @class */ (function () {
    ...
    UserController.getAll = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    e_1 = _a.sent();
                    return [2 /*return*/, res.status(404).json({ message: 'No result' })];
    ...
    UserController.newUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, username, password, role, user, errors, userRepository, e_3;
    ...
    UserController.editUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var user, id, _a, username, role, userRepository, e_4, errors, e_5;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    id = req.params.id;
                ...
                case 4: return [4 /*yield*/, class_validator_1.validate(user, { validationError: { target: false, value: false } })];
                case 5:
                    errors = _b.sent();
